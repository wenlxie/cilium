...
* ``drop_count_total``: Total drop requests, tagged by drop reason and ingress/egress direction
* ``forward_count_total``: Total forward requests, tagged by ingress/egress direction
